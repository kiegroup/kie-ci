...
//Define Variables
def folderPath = 'OSBS'
def prodComponent="${PROD_COMPONENT}"

folder(folderPath) 

pipelineJob("${folderPath}/${prodComponent}")  {

    parameters {
        stringParam("BUILD_DATE", Constants.BUILD_DATE)
        stringParam("PROD_VERSION", Constants.PROD_VERSION)
        stringParam("PROD_COMPONENT", Constants.PROD_COMPONENT)
        stringParam("OSBS_BUILD_TARGET", Constants.OSBS_BUILD_TARGET)
        stringParam("KERBEROS_PRINCIPAL", Constants.KERBEROS_PRINCIPAL)
        stringParam("OSBS_BUILD_USER", Constants.OSBS_BUILD_USER)
        stringParam("KERBEROS_KEYTAB", Constants.KERBEROS_KEYTAB)
        stringParam("KERBEROS_CRED", Constants.KERBEROS_CRED)
        stringParam("IMAGE_REPO", Constants.IMAGE_REPO)
        stringParam("IMAGE_BRANCH", Constants.IMAGE_BRANCH)
        stringParam("IMAGE_SUBDIR", Constants.IMAGE_SUBDIR)
        stringParam("GIT_USER", Constants.GIT_USER)
        stringParam("GIT_EMAIL", Constants.GIT_EMAIL)
        stringParam("CEKIT_CACHE_LOCAL", Constants.CEKIT_CACHE_LOCAL)
        stringParam("VERBOSE", Constants.VERBOSE)
    }
