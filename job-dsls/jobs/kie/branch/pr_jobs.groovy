...
def final REPO_CONFIGS = [
        'lienzo-core'               : [
                timeoutMins: 30,
                label: 'rhos-d-kie-rhel7 && kie-mem4g && !built-in',
        ...
        "droolsjbpm-knowledge"      : [
                label: "rhos-d-kie-rhel7 && kie-mem4g && !built-in && !built-in",
                excludedRegions: ['LICENSE.*', '\\.gitignore', '.*\\.md', '.*\\.adoc', '.*\\.txt']
        ],
        'appformer'                 : [
                label    : 'rhos-d-kie-rhel7 && kie-mem16g && !built-in',
                artifactsToArchive: [
        ...
        "droolsjbpm-integration"    : [
                timeoutMins: 300,
                label: "rhos-d-kie-rhel7 && kie-mem24g && !built-in",
                artifactsToArchive: [
        ...
        "kie-wb-common"             : [
                timeoutMins: 300,
                label: "rhos-d-kie-rhel7 && kie-mem16g && gui-testing && !built-in",
                executionNumber : 25,
                artifactsToArchive: [
                        "**/target/screenshots/**"
                ],
        ...
        "kie-wb-distributions"      : [
                label             : "rhos-d-kie-rhel7 && kie-mem24g && gui-testing && !built-in",
                timeoutMins       : 200,
                artifactsToArchive: [
                        "**/target/screenshots/**",
