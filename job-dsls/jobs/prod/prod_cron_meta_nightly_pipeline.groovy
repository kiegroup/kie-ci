...
def SERVERLESS_LOGIC_CURRENT_PRODUCT_VERSION='1.30.0'
def SERVERLESS_LOGIC_KOGITO_CURRENT_PRODUCT_VERSION='1.40.0'
def SERVERLESS_LOGIC_DROOLS_CURRENT_PRODUCT_VERSION='8.40.0'
def SERVERLESS_LOGIC_CURRENT_PRODUCT_BRANCH='1.40.x-integration-quarkus-lts'
def SERVERLESS_LOGIC_CURRENT_PRODUCT_CONFIG_BRANCH="openshift-serverless-logic/1.40.x"
