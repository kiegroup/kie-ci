...
def SERVERLESS_LOGIC_CURRENT_PRODUCT_VERSION='1.34.0'
def SERVERLESS_LOGIC_KOGITO_CURRENT_PRODUCT_VERSION='9.101.0'
def SERVERLESS_LOGIC_DROOLS_CURRENT_PRODUCT_VERSION='9.101.0'
def SERVERLESS_LOGIC_CURRENT_PRODUCT_BRANCH='9.101.x-prod'
def SERVERLESS_LOGIC_CURRENT_PRODUCT_CONFIG_BRANCH="openshift-serverless-logic/9.101.x"
