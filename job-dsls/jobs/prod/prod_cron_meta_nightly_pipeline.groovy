...
def SERVERLESS_LOGIC_CURRENT_PRODUCT_VERSION='1.29.0'
def SERVERLESS_LOGIC_KOGITO_CURRENT_PRODUCT_VERSION='1.38.0'
def SERVERLESS_LOGIC_DROOLS_CURRENT_PRODUCT_VERSION='8.38.0'
def SERVERLESS_LOGIC_CURRENT_PRODUCT_BRANCH='1.38.x-prod'
def SERVERLESS_LOGIC_CURRENT_PRODUCT_CONFIG_BRANCH="openshift-serverless-logic/1.38.x"
