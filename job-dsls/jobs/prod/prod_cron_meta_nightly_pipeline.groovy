...
pipeline{
    ...
    stages {
        ...
        ${kogitoNightlyStage(KOGITO_BLUE_NEXT_PRODUCT_VERSION, KOGITO_BLUE_NEXT_PRODUCT_BRANCH, OPTAPLANNER_NEXT_PRODUCT_VERSION, NEXT_BLUE_PRODUCT_VERSION, NEXT_BLUE_RHBA_VERSION_PREFIX, KOGITO_BLUE_NEXT_PRODUCT_CONFIG_BRANCH)}

        // Openshift Serverless Logic
        ${serverlessLogicNightlyStage(SERVERLESS_LOGIC_NEXT_PRODUCT_VERSION, SERVERLESS_LOGIC_DROOLS_NEXT_PRODUCT_VERSION, "kogito-${SERVERLESS_LOGIC_NEXT_PRODUCT_BRANCH}", SERVERLESS_LOGIC_NEXT_PRODUCT_CONFIG_BRANCH)}
