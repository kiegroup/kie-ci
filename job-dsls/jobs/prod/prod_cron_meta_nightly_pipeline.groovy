...
pipeline{
    ...
    stages {
        ...
        ${kogitoNightlyStage('1.13.x-blue', '1.13.x-blue', OPTAPLANNER_NEXT_PRODUCT_VERSION, NEXT_PRODUCT_VERSION, NEXT_RHBA_VERSION_PREFIX, KOGITO_NEXT_PRODUCT_CONFIG_BRANCH)}
