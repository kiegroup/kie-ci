...
pipelineJob("${folderPath}/rhbop-trigger-umb-message") {
    ...
    parameters {
        ...
        stringParam('DROOLS_VERSION', '8.29.0.Final-redhat-00014', 'The productized version of Drools used for building Red Hat Build of OptaPlanner currect milestone.')
        stringParam('QUARKUS_VERSION', '2.13.8.Final-redhat-00002', 'The productized version of Quarkus core used for building Red Hat build of OptaPlanner currect milestone.')
        stringParam('QUARKUS_PLATFORM_VERSION', '2.13.8.Final-redhat-00002', 'The productized version of Quarkus platform used for building Red Hat build of OptaPlanner currect milestone.')
