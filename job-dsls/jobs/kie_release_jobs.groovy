...
def ufDeploy="""
sh \$WORKSPACE/scripts/droolsjbpm-build-bootstrap/script/release/uf_createAnddeploy.sh
"""

def ufPushTag="""
sh \$WORKSPACE/scripts/droolsjbpm-build-bootstrap/script/release/uf_pushTag.sh
"""

def ufUpdateVersion="""
sh \$WORKSPACE/scripts/droolsjbpm-build-bootstrap/script/release/uf_updateVersion.sh
"""

def dashDeploy="""
sh \$WORKSPACE/scripts/droolsjbpm-build-bootstrap/script/release/dash_createAndDeploy.sh
"""

def dashPushTag="""
sh \$WORKSPACE/scripts/droolsjbpm-build-bootstrap/script/release/dash_pushTag.sh
"""

def dashUpdateVersion="""
sh \$WORKSPACE/scripts/droolsjbpm-build-bootstrap/script/release/dash_updateVersion.sh
"""
...
nestedView("KIE release for ${KIE_MAIN_BRANCH} branch"){
    views{
        ...
        listView("${UF_VERSION} UF Release"){
        ...
        listView("${DASH_VERSION} DASH Release"){
