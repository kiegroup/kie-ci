...
def KIE_MAIN_BRANCH="7.1.x"
def UF_MAIN_BRANCH="1.1.x"
def DASH_MAIN_BRANCH="0.7.x"
...
git clone https://github.com/kiegroup/droolsjbpm-build-bootstrap.git -b $KIE_MAIN_BRANCH
...
job("kie_${KIE_VERSION}_createAndPushReleaseBranches") {
    ...
    parameters {
        ...
        choiceParam("SOURCE", ["community-branch", "community-tag", "production-tag"], " please select the source of this release <br> or it is the 7.1.x branch ( <b> community-branch </b> ) <br> or a community tag ( <b> community-tag </b> ) <br> or a productization tag ( <b> production-tag </b> ) <br> ******************************************************** <br> ")
...
job("kie_${KIE_VERSION}_updateToNextDevelopmentVersion") {
    ...
    parameters {
        stringParam("BASE_BRANCH","7.1.x","Branch you want to upgrade")
