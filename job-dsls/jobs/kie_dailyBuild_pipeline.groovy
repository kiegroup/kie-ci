...
matrixJob("${folderPath}/jbpmTestCoverageMatrix-kieAllBuild-${kieMainBranch}") {
    ...
    parameters {
        ...
        stringParam("kieMainBranch", "kie branch", "please edit the branch of the KIE release <br> Will be supplied by the parent job. <br> Normally the kieMainBranch will be supplied by parent job <br> ******************************************************** <br> ")
    }
