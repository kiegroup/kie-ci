...
class Constants {
    ...
    static final String PROD_VERSION = "7.6.0"
    ...
    static final String CEKIT_CACHE_LOCAL = "http://download.eng.bos.redhat.com/released/JBoss-middleware/eap7/7.2.1/jboss-eap-7.2.1-patch.zip,http://download.eng.bos.redhat.com/released/JBoss-middleware/eap7/7.2.3/jboss-eap-7.2.3-patch.zip,http://download.eng.bos.redhat.com/released/JBoss-middleware/eap7/7.2.4/jboss-eap-7.2.4-patch.zip"
