...
class Constants {
    ...
    static final String BRANCH = '7.67.x-blue'
    ...
    static final String KIE_PREFIX = '7.67.2'
    static final String SONARCLOUD_FOLDER = 'sonarcloud'
    static final String REPORT_BRANCH = '7.x'
    static final String BUILD_DATE = ''
    static final String NEXT_PROD_VERSION = '7.14.0'
    static final String CURRENT_PROD_VERSION = '7.13.0'
