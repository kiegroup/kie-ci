...
class Constants {
    ...
    static final String ZANATA_VERSION = "7.25.0"
    static final String KIE_PREFIX = "7.25.0"
    static final String KIE_PROD_BRANCH_PREFIX = "7.25.x"
    static final String UBERFIRE_PREFIX = "2.22.0"
