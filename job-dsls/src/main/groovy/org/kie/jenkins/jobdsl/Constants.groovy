...
class Constants {
    ...
    static final String KIE_PREFIX = '7.75.0'
    ...
    static final String BAMOE_IMAGE_BRANCH = '7.13.x-blue-next'
    ...
    static final String RHPAM_KOGITO_OPERTOR_BRANCH = '1.13.x-next'
    static final String RHPAM_KOGITO_IMAGE_BRANCH = '1.13.x-next'
    static final String BAMOE_BA_OPERTOR_BRANCH = 'release-v7.13.x-blue-next'
    static final String BAMOE_KOGITO_OPERTOR_BRANCH = '1.13.x-blue-next'
    static final String BAMOE_KOGITO_IMAGE_BRANCH = '1.13.x-blue-next'
